...
//chair
    glPushMatrix();
    glTranslatef(-75,-80,0);
    glColor3f(0, 0, 0);
    glRectf(40.8,18.5,0,0);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(-75,-80,0);
    glColor3f(0.5, 0, 0);
    glRectf(40.0,16.5,0,0);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(-74.5,-80,0);
    glColor3f(0, 0, 0);
    glRectf(39.5,8.5,0,0);
    glPopMatrix();


    glPushMatrix();
    glTranslatef(-74.5,-79.5,0);
    glColor3f(0.9, 0, 0.1);
    glRectf(39.0,7.5,0,0);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(-68.7,-80,0);
    glRotatef(94, 0.0, 0.0, 1.0);//line
    glColor3f(0, 0, 0);
    glRectf(20.5,7.5,0,0);
    glPopMatrix();


    glPushMatrix();
    glTranslatef(-68.8,-79.5,0);
    glRotatef(94, 0.0, 0.0, 1.0);//line
    glColor3f(0.8, 0.1, 0.1);
    glRectf(19.0,7.4,0,0);
    glPopMatrix();


    glPushMatrix();
    glTranslatef(-32.5,-80,0);
    glRotatef(85, 0.0, 0.0, 1.0);//line
    glColor3f(0, 0, 0);
    glRectf(20.0,7.5,0,0);
    glPopMatrix();


    glPushMatrix();
    glTranslatef(-32.6,-80,0);
    glRotatef(85, 0.0, 0.0, 1.0);
    glColor3f(0.8, 0.1, 0.1);
    glRectf(19.4,7.0,0,0);
    glPopMatrix();
...
//head
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(66,-38,0); //upper body border
   // glRotatef(-20.0, 0.0, 0.0, 1.0);
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(57,-45,0); //upper body border
    glRotatef(-20.0, 0.0, 0.0, 1.0);
    circle(3,3);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(74,-46,0); //upper body border
    glRotatef(-20.0, 0.0, 0.0, 1.0);
    circle(3,3);
    glPopMatrix();
    ...
    //L
    glPushMatrix();
    glTranslatef(50.0,-48.0,0);
    glRotatef(-10, 0.0, 0.0, 1.0);//line
    glColor3f(0, 0, 0);
    glRectf(15.0,2.0,0,0);
    glPopMatrix();

    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(51,-47,0); //upper body border
    circle(2.5,2.3);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(50.0,-47.8,0);
    glRotatef(-10, 0.0, 0.0, 1.0);//line
    glColor3f(1.0, 0.9, 0.5);
    glRectf(14.5,1.5,0,0);
    glPopMatrix();

    glPushMatrix();
    glColor3f(1.0, 0.9, 0.5);
    glTranslatef(51,-46.9,0); //upper body border
    circle(2.2,2.0);
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef(67.5,-49.,0);
    glRotatef(-40, 0.0, 0.0, 1.0);//line
    glColor3f(0, 0, 0);
    glRectf(15.0,2.0,0,0);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(80,-58,0); //upper body border
    glRotatef(-20.0, 0.0, 0.0, 1.0);
    circle(2.3,2.1);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(1.0, 0.9, 0.5);
    glTranslatef(80,-58.0,0); //upper body border
    glRotatef(-20.0, 0.0, 0.0, 1.0);
    circle(2.0,1.8);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(70,-69,0); //upper body border
    circle(2.3,2.1);
    glPopMatrix();

    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(65,-69,0); //upper body border
    circle(2.3,2.1);
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef(64.0,-50.8,0);
    glColor3f(0, 0, 0);
    glRectf(4.48,3.25,0,0);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(64.2,-50.8,0);
    glColor3f(0.2, 0.8, 1);
    glRectf(4.0,3.22,0,0);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(1, .9, 0);
    glTranslatef(66,-38,0);  //upper body
    circle(7.2,7.4);
    glPopMatrix();

    glPushMatrix();
    glColor3f(1, 1, .7);
    glTranslatef(66,-40,0);  //upper body
    circle(7.2,7.2);
    glPopMatrix();

    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(66,-33,0); //upper body border
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(63,-38,0);
    circle(1,1);//left leg
    glPopMatrix();

    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(68,-38.0,0);
    circle(1,1);//left leg
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(65.8,-41,0); //upper body border
    circle(3,2);
    glPopMatrix();

    glPushMatrix();
    glColor3f(1, 1, .7);
    glTranslatef(65.8,-40.6,0); //upper body border
    circle(3,2);
    glPopMatrix();
...
//girl.........
 ...
 //ball
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(-15.0,-87.00,0); //upper body border
    circle(11.3,11.7);
    glPopMatrix();

    glPushMatrix();
    glColor3f(.9, 0, .1);
    glTranslatef(-15.0,-86.8,0); //upper body border
    circle(10.79,11.11);
    glPopMatrix();

    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(-14.98,-86.68,0); //upper body border
    circle(7.4,11.2);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(.9, 0, .1);
    glTranslatef(-14.95,-86.68,0); //upper body border
    circle(3.0,10.93);
    glPopMatrix();
...
//eyes
    ...
    glPushMatrix();
    glColor3f(0, 0, 0);
    glTranslatef(0,16.00,0); //upper body border
    circle(4.0,5.5);
    glPopMatrix();

     glPushMatrix();
    glColor3f(1, 0.5, .4);
    glTranslatef(-0.8,16.00,0); //upper body border
    circle(3.2,5.2);
    glPopMatrix();
...
void init(void)
{
    glClearColor (0.96, .64, 0.38, 80.0);
