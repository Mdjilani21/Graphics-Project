...
void display()
{
	...
	****************************/
	...
	glBegin(GL_TRIANGLES);
	{
        ...
        {
        glVertex3f(5, 0, 0);
	    glVertex3f(R*cos(t-a)+5, R*sin(t-a)+0, 0);
	    glVertex3f(R*cos(t)+5, R*sin(t)+0, 0);
...
glColor3f(1, 5, 0);
	glBegin(GL_TRIANGLES);
	{
        for(t=0;t<=PI_2;t+=a)
        {
        glVertex3f(15+x, 0+y, 0);
	    glVertex3f(R*cos(t-a)+15+x, R*sin(t-a)+0+y, 0);
	    glVertex3f(R*cos(t)+15+x, R*sin(t)+0+y, 0);
